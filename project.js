...
export const projects = [
  {
    ...
    icon: <i className='fas fa-lg fa-user-astronaut' />,
  ...
  },
  {
    ...
    icon: <i className='fas fa-lg fa-bread-slice' />,
  ...
  },
  {
    ...
    icon: <i className='fas fa-lg fa-search-dollar' />,
  ...
  },
  {
    ...
    icon: <i className='fas fa-lg fa-chess-king' />,
    image: '/img/chess.png',
  ...
  },
  {
    ...
    icon: <i className='fas fa-lg fa-calculator' />,
